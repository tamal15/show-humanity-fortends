...
const VirdhaAshramDonet = () => {
    ...
    const fetchData = () => {
      fetch('https://show-humanity-front-production.up.railway.app/institutions')
      .then(res => res.json())
      .then(data => {
    ...
    const managePost = model?.filter(models => models?.categories
        === 'VirdhaAshram' || models.role==='admin');
    console.log(model)
...
const style = {
  ...
  const onSubmit = data => {
    ...
    fetch("https://show-humanity-front-production.up.railway.app/postins", {
        method: "POST",
        headers: { "content-type": "application/json" },
            ...
            <Grid sx={{ py: 3 }} key={single._id} item xs={4} sm={4} md={3}>
              ...
              >
                <Grid  container spacing={2} columns={{ xs: 4, sm: 8, md: 4 }}>
                  ...
                  <Grid item xs={2} sm={4} md={8} pl={2} my={3}>
                    ...
                    <Typography variant="body">
                        <h5 style={{ fontWeight: 700 }}> Institution : {single?.categories}</h5>
                ...
                <Box sx={{ display: 'flex', justifyContent: '' }}>
                  ...
                  <Button
                  onClick={handleOpens}
                     className='btn-style download-btn ms-2'
                     style={{textAlign:"", padding:"7px 13px"}}
                    size="small">
                      Donate
                    </Button>
...
<form onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <input
                            style={{fontWeight:"500"}}
                            className='w-75 mb-3'  {...register("number", { required: true })} placeholder='number' /> <br />
                            <input
                            style={{fontWeight:"500"}}
                            className='w-75 mb-3'  {...register("instutition", { required: true })} placeholder='instutition Name' /> <br />
...
<input
                                ...
                                className='w-75 mb-3'  {...register("payment", { required: true })} placeholder='Payment' /> <br />
...
export default VirdhaAshramDonet;